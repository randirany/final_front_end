...
function AhlieReport() {
    ...
    const tableHeaders = useMemo(() => [
        ...
        { key: 'actions', label: t('ahliaReport.table.actions', 'Actions'), align: (language === 'ar' || language === 'he') ? 'left' : 'right' },
    ], [t, language]);
        ...
        <div className="px-4 py-5 dark:bg-dark2 dark:text-dark3 min-h-screen">
            ...
            <div className='flex rounded-md justify-between items-start flex-wrap my-2'>
                 <div className="flex gap-2 flex-wrap">
                    ...
                    <input type="text" placeholder={t('common.searchPlaceholder', "Search in Report ...")} className={`p-2 border rounded-md mb-4 dark:bg-gray-700 w-[300px] dark:text-[rgb(255,255,255)] dark:!border-none ${(language === 'ar' || language === 'he') ? 'text-right' : 'text-left'}`} value={searchText} onChange={(e) => setSearchText(e.target.value)} />
                </div>
