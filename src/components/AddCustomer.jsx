            ...
            >
                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* ID Number */}
                        <div>
                            <label htmlFor="id_Number_add" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t("customers.labels.idNumber")}</label>
                            <input
                                type="number"
                                id="id_Number_add"
                                name="id_Number"
                        ...
                        {/* Agent Dropdown */}
                        <div>
                            <label htmlFor="agentId_add" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t("customers.labels.agentName")}</label>
                            <select
                                id="agentId_add"
                                name="agentId"
