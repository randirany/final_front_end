...
function InsuranceList() {
    ...
    const formatDateForDisplay = (date) => {
        ...
        return new Date(date).toLocaleDateString((language === 'ar' || language === 'he') ? 'ar-SA' : 'en-US', { calendar: 'gregory' });
    };
