...
const EditCompanyModal = ({ open, onClose, companyId, onSuccess }) => {
    ...
    >
      <DialogTitle className="dark:text-white border-b dark:border-gray-700">
        <div className="flex justify-between items-center">
          <span>{t('companies.editCompany', 'Edit Insurance Company')}</span>
          <button
            onClick={handleClose}
      ...
      {fetching ? (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <DialogActions className="dark:bg-navbarBack dark:border-gray-700 border-t px-6 py-4">
            ...
            >
              {loading ? t('common.updating', 'Updating...') : t('companies.update', 'Update Company')}
            </Button>
          </DialogActions>
        </form>
      )}
