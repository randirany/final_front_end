  ...
  const fetchDocumentSettings = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: t('documentSettings.errorFetchingSettings'),
        icon: 'error'
      }).then(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: t('documentSettings.settingsUpdatedSuccessfully'),
        icon: 'success'
      }).then(() => {
        navigate('/document-settings');
      });
      ...
      Swal.fire({
        title: t('documentSettings.error'),
        text: error.response?.data?.message || t('documentSettings.errorUpdatingSettings'),
        icon: 'error'
      });
    } finally {
      setLoading(false);
          ...
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                {t('documentSettings.editSettings')}
              </h1>
              <p className="mt-1 text-sm text-gray-500 dark:text-dark3">
                {t('documentSettings.editSettingsSubtitle')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg bg-white shadow dark:bg-navbarBack">
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
                    ...
                    <div className="absolute top-2 right-2 flex gap-2">
                      {uploadedLogo && (
                        <button
                          ...
                          title={t('documentSettings.revertToOriginal')}
                        >
                      ...
                      <button
                        type="button"
                        onClick={uploadedLogo ? removeLogo : removeCurrentLogo}
                      ...
                      <div className="mt-2">
                        <label className="cursor-pointer">
                          <span className="text-sm font-medium text-gray-900 dark:text-white">
                            {t('documentSettings.replaceLogo')}
                          </span>
                          <input {...getInputProps()} />
                        </label>
                      </div>
            ...
            <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              >
                {loading ? t('documentSettings.updating') : t('documentSettings.updateSettings')}
              </button>
            </div>
          </form>
        </div>
...
export default EditDocumentSettings;